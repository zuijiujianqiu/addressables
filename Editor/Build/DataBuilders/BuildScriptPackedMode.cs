...
namespace UnityEditor.AddressableAssets.Build.DataBuilders
{
    ...
    public class BuildScriptPackedMode : BuildScriptBase
    {
        ...
        public List<ObjectInitializationData> m_ResourceProviderData;
        ...
        protected virtual TResult DoBuild<TResult>(AddressablesDataBuilderInput builderInput, AddressableAssetsBuildContext aaContext) where TResult : IDataBuilderResult
        {
            ...
            using (m_Log.ScopedStep(LogLevel.Info, "Generate JSON Catalog"))
            {
                ...
                contentCatalog.SetData(new List<ContentCatalogDataEntry>());
...
#else
        public bool CreateCatalogFiles(string jsonText, AddressablesDataBuilderInput builderInput, AddressableAssetsBuildContext aaContext, string catalogHash = null)
        {
        ...
        public static string[] CreateRemoteCatalog(string jsonText, List<ResourceLocationData> locations, AddressableAssetSettings aaSettings, AddressablesDataBuilderInput builderInput,
            ProviderLoadRequestOptions catalogLoadOptions, string contentHash)
        {
            string[] dependencyHashes = null;
